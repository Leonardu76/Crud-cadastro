...
if(isset($_POST['cadastrar'])){
    ...
    try{
        $stmt->execute();
        ?><div class="container"><h4 class='cadSucess'>Cadastro realizado com sucesso! Para ver <a href="index.php">Clique aqui.</a></h4></div>
           <?php
 ...
 if(isset($_POST['alterar'])){
    ...
    try{
    $stmt->execute();
     ?><div class="container"><h4 class='cadSucess'>Atualizado com sucesso! Para ver <a href="../index.php">Clique aqui.</a></h4></div>
        <?php
 ...
 if(isset($_POST['delete'])){
    ...
    try{
        $stmt->execute();
        ?><div class="container"><h2 class='cadSucess'>Cadastro Excluido com sucesso! Para vvoltar <a href="index.php">Clique aqui.</h2></div>
        <?php
