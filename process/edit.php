...
<div id="alterar" class="container">
    ...
    <input type="hidden" name="id" value="<?=$contact['id']?>">
        ...
        <div class="form-group">
            ...
            <input id="nameEd" class="col-sm-6" type="text" name="nameEd" value="<?= $contact['nome_cliente'] ?>" required>
        </div>

        <div class="form-group">
            <label class="emailEd" for="emailEd">Email</label> <br>
            <input id="emailEd" class="col-sm-6" type="text" name="emailEd" value="<?= $contact['email_cliente'] ?>" required>
        </div>

        <div class="form-group">
            <label class="phoneEd" for="phoneEd">Telefone</label> <br>
            <input id="phoneEd" class="col-sm-6" type="text" name="phoneEd" value="<?= $contact['telefone_cliente'] ?>" required>
        </div>

        <div class="form-group">
            <label class="passwordEd" for="passwordEd">Senha</label> <br>
            <input id="passwordEd" class="col-sm-6" type="password" name="passwordEd"value="<?= $contact['senha_cliente'] ?>" required>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="form-group"> <br>
                <input class="col-sm-6" type="submit" name="alterar" id="btn_edit">
            </div>
    </form>
</div>
